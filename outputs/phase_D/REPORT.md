...
- [x] 모델 성능 리포트 (CV Accuracy=0.8174)
...
| 샘플 수 | 460 |
| Feature 수 | 9 |
| 5-Fold CV Accuracy | **0.8174 ± 0.0502** |
| 5-Fold CV Weighted F1 | **0.8157 ± 0.0504** |
| Train Accuracy (참고, 과적합) | 1.0000 |
| Train Weighted F1 (참고, 과적합) | 1.0000 |

CV Accuracy Folds: [0.8043, 0.8913, 0.8587, 0.7717, 0.7609]
CV F1 Folds: [0.804, 0.8896, 0.8564, 0.7727, 0.7555]
...
|------|---------|------------|
| 3 | Energy & Atmosphere (EA) | 0.8840 |
| 5 | Indoor Env. Quality (EQ) | 0.6533 |
| 2 | Water Efficiency (WE) | 0.5895 |
| 1 | Location & Transportation (LT) | 0.4377 |
| 9 | LEED Version | 0.2880 |
| 7 | Sustainable Sites (SS) | 0.2400 |
| 4 | Materials & Resources (MR) | 0.1796 |
| 8 | Floor Area (log sqm) | 0.1622 |
| 6 | Integrative Process (IP) | 0.0066 |
...
- **Energy & Atmosphere (EA)** 이 등급 결정에 가장 큰 영향 (SHAP=0.8840)
- **Indoor Env. Quality (EQ)** 이 두 번째 영향 요인 (SHAP=0.6533)
