...
- [x] 모델 성능 리포트 (CV Accuracy=0.8239)
...
| 샘플 수 | 460 |
| Feature 수 | 9 |
| 5-Fold CV Accuracy | **0.8239 ± 0.0160** |
| Train Accuracy | 1.0000 |
| Weighted F1-Score | 1.0000 |

CV 각 Fold: [0.7935, 0.837, 0.837, 0.8261, 0.8261]
...
|------|---------|------------|
| 3 | Energy & Atmosphere (EA) | 0.8713 |
| 5 | Indoor Env. Quality (EQ) | 0.7234 |
| 2 | Water Efficiency (WE) | 0.6055 |
| 1 | Location & Transportation (LT) | 0.4317 |
| 9 | LEED Version | 0.2739 |
| 7 | Sustainable Sites (SS) | 0.2538 |
| 4 | Materials & Resources (MR) | 0.1751 |
| 8 | Floor Area (log sqm) | 0.1435 |
...
- **Energy & Atmosphere (EA)** 이 등급 결정에 가장 큰 영향 (SHAP=0.8713)
- **Indoor Env. Quality (EQ)** 이 두 번째 영향 요인 (SHAP=0.7234)
