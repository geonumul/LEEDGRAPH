...
Key finding: **Energy & Atmosphere (EA)** is the dominant grade determinant (mean |SHAP|=0.8713), followed by **Indoor Env. Quality (EQ)** and **Water Efficiency (WE)**.
...
|------|----------|------------|
| 2 | Energy & Atmosphere (EA) | 0.8713 |
| 3 | Indoor Env. Quality (EQ) | 0.7234 |
| 4 | Water Efficiency (WE) | 0.6055 |
| 5 | Location & Transportation (LT) | 0.4317 |
| 6 | LEED Version | 0.2739 |
